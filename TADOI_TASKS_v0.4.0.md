...
- `TD-001` Update active docs to `v0.4.0` baseline alignment. (`Complete`)
- `TD-002` Create versioned spec artifact: `TADOI_SPEC_v0.4.0.md`. (`Complete`)
- `TD-003` Create versioned task artifact: `TADOI_TASKS_v0.4.0.md`. (`Complete`)
...
Reference: `docs/TADOI_QA_Guide_v0.4.0.md`

## D) Next Candidate Phase (v0.4.0 Planning)
...
1. Runtime baseline remains `v0.4.0` / `0.4.0`.
