...
## Status
Notion sync is currently blocked in this environment due MCP OAuth refresh failure (`invalid_grant`).  
This pack is prepared for manual apply in Notion and is the canonical payload for repeat syncs.
...
- `date:Date:start`: `2026-02-12`
- `Notes`: `Synced to v0.3.5 runtime and latest automated snapshot (445/445 pass, typecheck pass). Calendar docs aligned to Backup Center import/export flows and CLI boundaries.`
