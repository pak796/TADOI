...
|---|---|---|
| Installation guide (all platforms) | `TADOI Installation Guide (All Platforms) v0.3.9` | `3045aa1e-f93f-8191-848a-cbc69ec6e869` |
| Installation guide (concise) | `TADOI Install Guide (Concise) v0.3.9` | `3065aa1e-f93f-8188-adb2-c39dc13f90bb` |
| `docs/USAGE.md` | `TADOI Usage Guide v0.3.9` | `3065aa1e-f93f-81b5-a6cb-d4d3e64684c0` |
| `docs/TADOI_QA_Guide_v0.3.9.md` | `TADOI QA Guide (v0.3.9)` | `3045aa1e-f93f-8103-bda5-f77d2bf55e8e` |
| `docs/QA/SMOKE_TEST_CHECKLIST.md` | `TADOI Smoke Test Checklist (v0.3.9)` | `3065aa1e-f93f-81ec-8bd6-cba6cf3876eb` |
| `docs/QA/BLACK_BOX_TEST_MATRIX.md` | `TADOI Black Box Test Matrix (v0.3.9)` | `3065aa1e-f93f-8178-af7d-c31a8241854d` |
| `docs/QA/REGRESSION_AREAS.md` | `TADOI Regression Areas (v0.3.9)` | `3065aa1e-f93f-8166-998c-d94e5bc16917` |
| Release checklist | `TADOI Release Checklist (v0.3.9)` | `3065aa1e-f93f-819b-a606-e8337a7ca1d5` |
| Release notes | `TADOI Release Notes` | `3065aa1e-f93f-81ed-9312-f1e427c167da` |
| `docs/ARCHITECTURE_OVERVIEW.md` | `TADOI Architecture Overview (v0.3.9)` | `3065aa1e-f93f-8131-b0ed-c9b0dfd1ad0e` |
| `README.md` | `TADOI User Guide (v0.3.9)` | `3045aa1e-f93f-810c-82a5-c03e17858168` |
| `docs/TADOI_Feature_List_v0.3.9.md` | `TADOI App Overview + Feature Catalog (v0.3.9)` | `3045aa1e-f93f-81fd-84cd-c93a6b68b49c` |
| `TADOI_SPEC_v0.3.9.md` | `TADOI Product Spec (v0.3.9)` | `3055aa1e-f93f-812d-ad44-f3d94b8a7219` |
| `TADOI_TASKS_v0.3.9.md` | `TADOI Task List (v0.3.9)` | `3055aa1e-f93f-8159-b07c-ee692df137eb` |
