...
Sync status: `Pending manual apply (2026-02-12; MCP auth invalid_grant refresh token)`

## 1) Sync Policy
- Keep Notion guide content aligned to current runtime (`v0.3.5`) and package (`0.3.5`).
...
- Title: `TADOI Installation Guide (All Platforms) v0.3.5`
- Source: `docs/TADOI_Installation_Guide_All_Platforms.md`

### QA Guide
- Page ID: `3045aa1e-f93f-8103-bda5-f77d2bf55e8e`
- Title: `TADOI QA Guide (v0.3.5)`
- Source: `docs/TADOI_QA_Guide_v0.3.5.md`

### User Guide
- Page ID: `3045aa1e-f93f-810c-82a5-c03e17858168`
- Title: `TADOI User Guide (v0.3.5)`
- Source: `README.md`

### App Overview + Feature Catalog
- Page ID: `3045aa1e-f93f-81fd-84cd-c93a6b68b49c`
- Title: `TADOI App Overview + Feature Catalog (v0.3.5)`
- Source: `docs/TADOI_Feature_List_v0.3.5.md`

### Product Spec
- Page ID: `3055aa1e-f93f-812d-ad44-f3d94b8a7219`
- Title: `TADOI Product Spec (v0.3.5)`
- Source: `TADOI_SPEC_v0.3.5.md`

### Task List
- Page ID: `3055aa1e-f93f-8159-b07c-ee692df137eb`
- Title: `TADOI Task List (v0.3.5)`
- Source: `TADOI_TASKS_v0.3.5.md`

## 3) Target Property Baseline
For each updated page:
- `Name`: includes `v0.3.5` where applicable.
...
- Confirm calendar docs state:
  ...
  - top-level `calendar:import` CLI route is still pending
...
## 5) Execution Note
- Direct Notion MCP write access is currently blocked in this environment (`invalid_grant` refresh-token failure).
