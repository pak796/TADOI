...
complete -c tadoi -n "__fish_seen_subcommand_from add done due recur note capture nq help" -l help -s h -d "Show command help"
...
complete -c tadoi -n "__fish_seen_subcommand_from remind" -l event -r -d "Reminder event id"
complete -c tadoi -n "__fish_seen_subcommand_from remind" -l help -s h -d "Show remind help"
