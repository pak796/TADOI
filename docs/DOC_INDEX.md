...
Updated: 2026-02-13
Active runtime baseline: `v0.3.6`
...
- `TADOI_SPEC_v0.3.6.md`: current runtime behavior/spec contract.
- `TADOI_TASKS_v0.3.6.md`: active implementation and documentation task ledger.
- `TADOI_Spec_Calendar_Export_ICS_v0.2.md`: ICS export contract and behavior details.
- `TADOI_Spec_Calendar_Import_ICS_RoundTrip_v0.1.md`: ICS import contract and implementation notes.
