...
Updated: 2026-02-12
Active runtime baseline: `v0.3.5`

## 1) Start Here
- `README.md`: product overview, quickstart, keybindings, packaging, data paths.
...
- `docs/TADOI_QA_Guide_v0.3.5.md`: full manual QA matrix and smoke checklist.
- `docs/TADOI_Feature_List_v0.3.5.md`: release-accurate feature catalog.

## 3) Active Spec and Planning
- `TADOI_SPEC_v0.3.5.md`: current runtime behavior/spec contract.
- `TADOI_TASKS_v0.3.5.md`: active implementation and documentation task ledger.
- `TADOI_Spec_Calendar_Export_ICS_v0.2.md`: ICS export contract and behavior details.
- `TADOI_Spec_Calendar_Import_ICS_RoundTrip_v0.1.md`: ICS import foundation plan/status (service layer implemented; CLI pending).
...
- `docs/ops/notion_v0.3.5_sync_pack.md`: Notion sync payload details.
...
- Active release documentation should prefer the `v0.3.5` files listed above.
