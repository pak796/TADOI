...
- `docs/TADOI_QA_Guide_v0.3.8.md`: full manual QA matrix (`QA-001`..`QA-072`).
...
- `docs/TADOI_Feature_List_v0.3.8.md`: release-accurate feature catalog.

## 3) Active Spec and Planning
- `TADOI_SPEC_v0.3.8.md`: current runtime behavior/spec contract.
- `TADOI_TASKS_v0.3.8.md`: active implementation and documentation task ledger.
...
- Historical release artifacts (`v0.2.x`, `v0.3.0`, `v0.3.1`, `v0.3.4`, `v0.3.5`, `v0.3.7`) are retained for traceability.
- Use `docs/HISTORICAL_DOCS_INDEX.md` as the single lookup entry.
- Active release documentation should prefer the `v0.3.8` files listed above.
