...
5. Verify notes/audit token and metadata:
   - Confirm `Notes` includes `[AUDIT 2026-02-25] Docs audit + payload refresh staged for deferred apply` on all mapped pages.
   - Review `docs/notion/NOTION_SYNC_VERIFY_2026-02-25.json` for title/date/heading/version/notes summary.
