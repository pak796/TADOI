...
- `TD-001` Update active docs to `v0.3.8` baseline alignment. (`Complete`)
- `TD-002` Create versioned spec artifact: `TADOI_SPEC_v0.3.8.md`. (`Complete`)
- `TD-003` Create versioned task artifact: `TADOI_TASKS_v0.3.8.md`. (`Complete`)
...
## D) Next Candidate Phase (v0.3.8 Planning)
...
1. Runtime baseline remains `v0.3.8` / `0.3.8`.
